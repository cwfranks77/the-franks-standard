...
const { emergencyRestart } = require('#backend/launch/emergency.js')
...
export default defineEventHandler(async (event) => {
  ...
  if (body.confirm !== true) {
    throw createError({
      statusCode: 400,
      statusMessage: 'Set confirm:true to restart after emergency shutdown.',
    })
  }

  return emergencyRestart(sb, { triggeredBy: 'ops' })
})
