...
const smoke = `/** Owner smoke tests — run in browser before/after deploy. */
...
fs.writeFileSync(path.join(root, 'composables/useOpsSmokeTests.js'), smoke, 'utf8')
console.log('wrote composables/useOpsSmokeTests.js')
