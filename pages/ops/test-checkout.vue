<template>
  <div class="test-page">
    <div class="container">
      ...
      <section class="test-card">
        <h2>5. If checkout fails</h2>
        <ul class="bullet-list">
          <li>Stripe Dashboard → <a href="https://dashboard.stripe.com/settings/tax" target="_blank" rel="noopener">Settings → Tax</a> — turn on Stripe Tax and register at least one US state.</li>
          <li>Supabase → Edge Functions → <code>create-platform-checkout-session</code> → Logs (look for tax or Connect errors).</li>
