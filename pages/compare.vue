    ...
    <section class="section section-dark">
      <div class="container">
        ...
        <ul class="unique">
          ...
          <li><strong>Seller proof on collectibles:</strong> Uploaded COA or Franks COA required for collectible categories — enforced listing rules, not a Platform authenticity warranty.</li>
