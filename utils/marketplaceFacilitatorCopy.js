/**
 * Marketplace facilitator positioning (not legal advice).
 * The Platform connects buyers and sellers; it does not guarantee item authenticity.
 */

export const SITE_FACILITATOR_NAME = 'The Franks Standard LLC'
...
/** Trust quote (replaces “if it is here it is real — or we enforce…”) */
export const TRUST_QUOTE =
  'Sellers back what they list. We facilitate the sale, screen for risk, and enforce when proof fails — we never represent an item as ours to guarantee.'

export const TRUST_QUOTE_FOOT =
  'Escrow · policy enforcement · seller bans for proven fraud — not Platform authentication of every item.'
