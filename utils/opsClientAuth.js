...
/** Pure JS SHA-256 — works on http:// (browser crypto.subtle needs HTTPS). */
function sha256HexUtf8 (message) {
...
function sha256Bytes (data) {
  ...
  const withOne = new Uint8Array(((data.length + 9 + 63) & ~63))
  withOne.set(data)
...
export async function hashOpsPhraseBrowser (input) {
  return sha256HexUtf8(normalizeOpsPhrase(input))
}
