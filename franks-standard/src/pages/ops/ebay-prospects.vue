  ...
  <div class="prospect-page">
    <div class="container">
      ...
      <section class="card panel alt-way">
        ...
        <NuxtLink to="/ops/seller-lookup" class="btn btn-outline btn-sm" style="margin-left:8px">Desktop</NuxtLink>
      </section>

      <p class="back-link">
        <NuxtLink to="/ops/panel">← Operator console</NuxtLink>
        ·
        <NuxtLink to="/ops/seller-lookup">Find sellers (Google)</NuxtLink>
        ·
