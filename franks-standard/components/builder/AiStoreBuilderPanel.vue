        ...
        <div class="builder-preview-side">
          ...
          <div v-else class="preview-result">
            ...
            <div class="result-actions">
              ...
              <NuxtLink
                v-if="store.style === 'dropship' || store.style === 'both'"
                to="/sell/dropship-setup"
                class="btn btn-outline"
              >Dropship AI setup</NuxtLink>
...
.builder-hero h1 { font-size: 2rem; margin: 12px 0 8px; color: #f9fafb; }
.hero-lead { max-width: 640px; margin: 0 auto; color: #e5e7eb; font-weight: 600; line-height: 1.5; }
.ai-badge {
